...
[**refreshPersonId**](PersonApi.md#refreshpersonid) | **PUT** /api/person/id/refresh | 
...
try {
    final response = api.refreshPersonId();
    print(response);
} catch on DioError (e) {
    print('Exception when calling PersonApi->refreshPersonId: $e\n');
}
```
