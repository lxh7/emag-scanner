...
class CategoryApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CategoryDTO>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CategoryDTO>>> listCategories({ 
    ...
    BuiltList<CategoryDTO> _responseData;
